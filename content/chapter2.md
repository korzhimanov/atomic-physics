...
$$
где $\sigma = ca/4 = 5.670367(13)\times 10^{-8}~\frac{\textnormal{Дж}}{\textnormal{с}\cdot\textnormal{м}^2\cdot\textnormal{К}^4}$ --- постоянная Стефана --- Больцмана.
...
Этот закон и носит название закона смещения Вина. Коэффициент $b$ называется постоянной Вина и равен $0,002898~\textnormal{м}\cdot\textnormal{К}$.
...
$$h = 6,626070040(81)\times 10^{-34}~\textnormal{Дж}\cdot\textnormal{с}$$
...
$$\hbar = 1,054571800(13)\times 10^{-34}~\textnormal{Дж}\cdot\textnormal{с}$$
