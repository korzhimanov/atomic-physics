...
E_\nu = h\nu
$$
Электрон приобретает энергию в результате поглощения одного фотона. Величина этой энергии может быть определена из закона сохранения энергии:
$$
E^{\text{кин}} = h\nu - A_{\text{вых}}
$$
где величина $A_{\text{вых}}$ получила название работы выхода и равна работе, которую необходимо совершить, чтобы вырвать электрон из тела. Приведённое выше уравнение называется уравнением Эйнштейна для фотоэффекта.
...
Теория Эйнштейна была детально проверена в экспериментах Оуэна Ричардсона и Карла Комптона в 1912 году и Роберта Милликена в 1916 году. Они подтвердили справедливость теории, хотя, например, Милликен изначально затевал свои опыты в надежде опровергнуть квантовую теорию света.
...
Сам Эйнштейн называл введёные им частицы света просто квантами света (нем. _das Lichtquant_). В 1926 году, однако, химик Гилберт Н. Льюис предложил дать этим частицам название «фотоны» от греч. $\varphi\omega\sigma$, «phos» («свет»). Именно оно и закрепилось в дальнейшем.
