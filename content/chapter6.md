...
$$
\hbar\omega\psi = \left[-\frac{\hbar^2}{2m} + U(\vec r)\right]\psi
$$
...
$$
-\frac{\hbar^2}{2m}\psi + U(\vec r)\psi = E\psi
$$
...
На это вопрос отвечают постулаты квантовой механики. Перечислим их:
...
4. При измерении значения динамической переменной $A$ оно может принимать только те значения, который являются собственными для уравнения:
$$
\hat A\Psi = A\Psi
$$
