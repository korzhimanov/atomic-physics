...
$$
Это называется правилом сложения моментов импульса и справедливо не только для системы двух невзаимодействующих частиц, но и для системы любых двух невзаимодействующих подсистем, а также для моментов импульсов одной той же частицы (например, при сложении моментов импульса её вращения вокруг собственной оси и вокруг некой внешней оси).
