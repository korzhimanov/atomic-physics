...
2. Правила отбора не распространяются на неэлектромагнитные процессы. То есть запрещённые правилами отбора переходы могут происходить в результате электронного удара или взаимодействия с тепловыми колебаниями.
