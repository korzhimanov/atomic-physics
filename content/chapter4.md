...
date: 2016-09-02
keywords: [физика, волны де Бройля, дифракция электронов, копускулярно-волновой дуализм]
lang: ru-RU
---
...
$$
Входящие в выражение для этой волны величины частоты $\omega$ и волнового вектора $\vec k$ де Бройль предложил связать с энергией и мпульсом частицы аналогично связи, установленной для фотонов:
$$
E = \hbar\omega \\
\vec p = \hbar \vec k
$$
...
$$
v_ф = \frac{\omega}{k} = \frac{E}{p} = \frac{\gamma mc^2}{\gamma mv} = \frac{c^2}{v}
$$
...
$$
v_{гр} = \frac{d\omega}{dk} = \frac{dE}{dp}
$$
...
$$
\lambda = \frac{1,225\ нм}{\sqrt{E[эВ]}}
$$
