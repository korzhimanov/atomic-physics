...
Систематическое исследование эффекта, проведённые Александром Григорьевичем Столетовым в 1888--1890 годах, показало, что сила тока насыщения при фотоэффекте пропорциональна интенсивности излучения. Это стало содержанием так называемого первого закона фотоэффекта.
...
$$E^{кин} = h\nu - A_{вых}$$
где величина $A_{вых}$ получила название работы выхода и равна работе, которую необходимо затратить, чтобы вырвать электрон из тела. Приведённое выше уравнение называется уравнением Эйнштейна для фотоэффекта. Оно объясняет все три закона фотоэффекта:
...
Сам Эйнштейн называл введёные им частицы света просто квантам света (нем. _das Lichtquant_). В 1926 году, однако, химиком Гилбертом Н. Льюисом им было дано название «фотоны» от греч. φῶς, «phōs» («свет»). Это название и закрепилось в дальнейшем.
...
$$
\vec p_ф + \vec p_e = \vec p_ф^\prime + \vec p_e^\prime \\
E_ф + E_e = E_ф^\prime + E_e^\prime
$$
где $\vec p_ф, E_ф$ --- импульс и энергия фотона до столкновения; $\vec p_ф^\prime, E_ф^\prime$ --- импульс и энергия фотона после столкновения; $\vec p_e, E_e$ --- импульс и энергия электрона до столкновения; $\vec p_e^\prime, E_e^\prime$ --- импульс и энергия электрона после столкновения. Обычно можно пренебречь энергией теплового движения электрона по сравнению с энергией фотона, и считать электрон изначально неподвижным: $\vec p_e = 0$, $E_e = m_ec^2$.

Выразим из закона сохранения импульса величину $\vec p_e^\prime$ и найдём её квадрат:
$$
\left(\vec p_e^\prime\right)^2 \equiv {p_e^\prime}^2 = \left( \vec p_ф -  \vec p_ф^\prime\right)^2 = p_ф^2 + {p_ф^\prime}^2 - 2p_фp_ф^\prime \cos\vartheta
$$
...
$$
{E_e^\prime}^2 = m_e^2c^4 + E_ф^2 + {E_ф^\prime}^2 - 2E_фE_ф^\prime + 2m_ec^2(E_ф-E_ф^\prime)
$$
Учтём теперь связь между энергией и импульсом:
$$
{E_e^\prime}^2 = m_e^2c^4 + {p_e^\prime}^2c^2 \\
E_ф = p_фc \\
E_ф^\prime = p_ф^\prime c
$$
и совместим оба полученных выражения, исключив импульс электрона:
$$
m_e^2c^4 + \left(p_ф^2 + {p_ф^\prime}^2 - 2p_фp_ф^\prime \cos\vartheta\right) c^2 =
 m_e^2c^4 + p_ф^2c^2 + {p_ф^\prime}^2c^2 - 2p_фp_ф^\prime c^2 + 2m_ec^3(p_ф-p_ф^\prime) \\
2p_фp_ф^\prime \cos\vartheta = 2p_фp_ф^\prime c^2 + 2m_ec(p_ф-p_ф^\prime) \\
\frac{1}{p_ф^\prime} - \frac{1}{p_ф} = \frac{1 - \cos\vartheta}{m_ec}
$$
Это выражение может быть получено и из классических соображений, но чтобы вывести из него спектральные характеристики света, необходимо установить связь между импульсом фотона и его частотой и длиной волны. Эта связь, полученная нами в предыдущей лекции, имеет, согласно Эйнштейну, вид
...
Величина $\frac{h}{m_ec}$ носит название комптоновской длины волны $\lambda_к$. Она характеризует ту частицу, на которой происходит рассеяние --- в данном случае электрон. Аналогичную величину можно вычислить и для других заряженных частиц --- протона и т. п. Для электрона комптоновская длина волны численно равна:
$$
\lambda_к = 2,4263096 \cdot 10^{-12} м
$$
Часто также в расчётах полезно ввести редуцированную комптоновскую длину волны:
$$
\rlap{-}\lambda_к = \frac{\lambda_к}{2\pi} = \frac{\hbar}{m_ec}
$$
